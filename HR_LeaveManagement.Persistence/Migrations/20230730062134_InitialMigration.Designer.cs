...
namespace HR_LeaveManagement.Persistence.Migrations
{
    ...
    [Migration("20230730062134_InitialMigration")]
            ...
            modelBuilder.Entity("HR.LeaveManagement.Domain.LeaveType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2023, 7, 30, 14, 21, 34, 508, DateTimeKind.Local).AddTicks(9937),
                            DateModified = new DateTime(2023, 7, 30, 14, 21, 34, 508, DateTimeKind.Local).AddTicks(9947),
                            DefaultDays = 10,
                            Name = "Vocation"
                        });
                });
